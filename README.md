...
- **[`paper/`](paper/)**: LaTeX draft of a research paper extending the 2011
  study using the public-trace results. Structure: model, datasets, fit
  validation, parameter-scaling law, sizing accuracy versus practitioner
  baselines, SLA-aware sizing with public cloud pricing (AWS, GCP, Azure).
  Numeric macros in `paper/paper_macros.tex` are auto-generated by
  `scoping/build_paper_macros.py`. Build with `pdflatex paper && bibtex
